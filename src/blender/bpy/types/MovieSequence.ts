...
export class MovieSequence {
    ...
    /**
     * 
     * @desc bpy_prop_collection of SequenceElement, (readonly)
     */
    public get elements(): BlenderCollection<SequenceElement> & Indexable<SequenceElement> {
        return BlenderCollection.createGeneric(this.interop, `${this.accessor}.elements`, SequenceElement)
    }
     ...
     */
    public get mpeg_preseek(): number {
        return PythonInterop.getInteger(this.interop, `${this.accessor}.mpeg_preseek`)
    }
     ...
     */
    public get stream_index(): number {
        return PythonInterop.getInteger(this.interop, `${this.accessor}.stream_index`)
    }
     ...
     * @desc int in [0, 50], default 0
     */
    public set mpeg_preseek(value: number) {
        PythonInterop.setInteger(this.interop, `${this.accessor}.mpeg_preseek`, value)
    }
     ...
     * @desc int in [0, 20], default 0
     */
    public set stream_index(value: number) {
        PythonInterop.setInteger(this.interop, `${this.accessor}.stream_index`, value)
    }
