...
import { ThemeGradientColors } from './ThemeGradientColors'
 ...
 */
export class ThemeSpaceGradient {

    constructor(public interop: BlenderInterop, public accessor: string) { }

    /**
     * 
     * @desc ThemeGradientColors, (readonly, never None)
     */
    public get gradients(): ThemeGradientColors {
        return PythonInterop.getClass(this.interop, `${this.accessor}.gradients`, ThemeGradientColors)
    }
