...
import { PointCaches } from './PointCaches'
import { PointCacheItem } from './PointCacheItem'
...
export class PointCache {
    ...
    /**
     * 
     * @desc PointCaches bpy_prop_collection of PointCacheItem, (readonly)
     */
    public get point_caches(): BlenderCollection<PointCacheItem> & Indexable<PointCacheItem> & PointCaches {
        return BlenderCollection.createSpecialized(this.interop, `${this.accessor}.point_caches`, PointCaches, PointCacheItem)
    }
