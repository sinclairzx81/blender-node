 ...
 * WoodTexture
 * 
 * https://docs.blender.org/api/current/bpy.types.WoodTexture.html
 */
export class WoodTexture {
    ...
    /**
     * 
     * @desc enum in ['BANDS', 'RINGS', 'BANDNOISE', 'RINGNOISE'], default 'BANDS'
     */
    public get wood_type(): 'BANDS' | 'RINGS' | 'BANDNOISE' | 'RINGNOISE' {
        return PythonInterop.getEnum(this.interop, `${this.accessor}.wood_type`)
    }
     ...
     * @desc enum in ['BANDS', 'RINGS', 'BANDNOISE', 'RINGNOISE'], default 'BANDS'
     */
    public set wood_type(value: 'BANDS' | 'RINGS' | 'BANDNOISE' | 'RINGNOISE') {
        PythonInterop.setEnum(this.interop, `${this.accessor}.wood_type`, value)
    }
