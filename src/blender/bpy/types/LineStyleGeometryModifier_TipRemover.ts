 ...
 */
export class LineStyleGeometryModifier_TipRemover {
     ...
     */
    public get tip_length(): number {
        return PythonInterop.getFloat(this.interop, `${this.accessor}.tip_length`)
    }
     ...
     * @desc float in [-inf, inf], default 0.0
     */
    public set tip_length(value: number) {
        PythonInterop.setFloat(this.interop, `${this.accessor}.tip_length`, value)
    }
