 ...
 * MetaSequence
 * 
 * https://docs.blender.org/api/current/bpy.types.MetaSequence.html
 */
export class MetaSequence {
     ...
     */
    public get sequences(): BlenderCollection<Sequence> & Indexable<Sequence> {
        return BlenderCollection.createGeneric(this.interop, `${this.accessor}.sequences`, Sequence)
    }
