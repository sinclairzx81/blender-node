 ...
 * 
 * https://docs.blender.org/api/current/bpy.types.LineStyleThicknessModifier_DistanceFromObject.html
 */
export class LineStyleThicknessModifier_DistanceFromObject {
