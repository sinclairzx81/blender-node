 ...
 * 
 * https://docs.blender.org/api/current/bpy.types.LineStyleThicknessModifier_Curvature_3D.html
 */
export class LineStyleThicknessModifier_Curvature_3D {
     ...
     */
    public get curvature_max(): number {
        return PythonInterop.getFloat(this.interop, `${this.accessor}.curvature_max`)
    }
     ...
     * @desc float in [0, 10000], default 0.0
     */
    public get curvature_min(): number {
        return PythonInterop.getFloat(this.interop, `${this.accessor}.curvature_min`)
    }
     ...
     * @desc float in [0, 10000], default 0.0
     */
    public set curvature_max(value: number) {
        PythonInterop.setFloat(this.interop, `${this.accessor}.curvature_max`, value)
    }
     ...
     * @desc float in [0, 10000], default 0.0
     */
    public set curvature_min(value: number) {
        PythonInterop.setFloat(this.interop, `${this.accessor}.curvature_min`, value)
    }
