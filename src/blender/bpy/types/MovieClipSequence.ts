 ...
 * MovieClipSequence
 * 
 * https://docs.blender.org/api/current/bpy.types.MovieClipSequence.html
 */
export class MovieClipSequence {
     ...
     */
    public get stabilize2d(): boolean {
        return PythonInterop.getBoolean(this.interop, `${this.accessor}.stabilize2d`)
    }
     ...
     * @desc boolean, default False
     */
    public get undistort(): boolean {
        return PythonInterop.getBoolean(this.interop, `${this.accessor}.undistort`)
    }
     ...
     * @desc boolean, default False
     */
    public set stabilize2d(value: boolean) {
        PythonInterop.setBoolean(this.interop, `${this.accessor}.stabilize2d`, value)
    }
     ...
     * @desc boolean, default False
     */
    public set undistort(value: boolean) {
        PythonInterop.setBoolean(this.interop, `${this.accessor}.undistort`, value)
    }
